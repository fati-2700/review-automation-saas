import { BrandVoiceSettings } from '@prisma/client';
...
export function generateResponse({ rating, brandVoice, contact = '[contact]' }: GenerateResponseParams): string {
  let baseResponse = '';
...
export function adjustTone(text: string, tone: string = 'professional'): string {
